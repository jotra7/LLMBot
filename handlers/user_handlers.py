...
'image_gen': (
    ...
    "\n"
    "🌟 New Features:\n"
    "- Photomaker Style: Upload up to 4 images and add a creative prompt to generate unique artwork.\n"
    "- Become Image: Transform your photo to match the style of any artwork or image.\n"
    "\n"
